...
const transform = {
  ...
  transformRequestHook: (res, options) => {
    ...
    // 这里逻辑可以根据项目进行修改
    const hasSuccess = resultData && Reflect.has(resultData, 'code') && code === 200
    const hasSuccessMessage = hasSuccess && isString(message) && message.length > 0 && data == null
    ...
    deepMerge(
      {
        ...
        requestOptions: {
          ...
          // 接口地址
          apiUrl: isMock ? mockUrl : import.meta.env.VITE_GLOB_API_URL,
          // 接口拼接地址
          urlPrefix,
          //  是否加入时间戳
          joinTime: true,
